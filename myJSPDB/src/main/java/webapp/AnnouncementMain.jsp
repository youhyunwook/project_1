...
<div style="position: relative; width: 100%; height: auto; overflow: hidden;">
	...
	<div id='content_box' style="position: relative; z-index: 1; margin-top: -130px; padding: 20px; background-color: rgba(255, 255, 255, 0.8);">
...
/* 	    boolean hasData = false; // 데이터를 가져왔는지 여부를 확인하는 변수 */
        ...
        System.out.println("User Role: " + useRole);
       ...
       <!-- 페이지네이션 링크 -->
		<div id='button' style="text-align: center; ">
		    ...
		    if (useRole != null && "admin".equals(useRole)) {
		    %>
		    <button onclick="location.href='AnnouncementWrite.jsp'" class="Ann_admin_commit">등록</button>
		    <%
		        } else {
		            System.out.println("User Role: " + useRole);
		        }
