...
<body>	
	...
	<div class="card-front" style="position:relative; max-height:700px;">
		...
		<div class="form-group">
			...
			<input type="text" id="customer_user_name" name="customer_user_name" class="form-style_b1" style="width:250px; margin-left:30px;" required><br>
		</div>
		<div class="form-group">
			<label for="customer_user_email" style="margin-left:30px;"> E-MAIL</label><br>
			<input type="text" id="customer_user_email" name="customer_user_email" class="form-style_b1" style="width:250px; margin-left:30px;" required><br>
		</div>
