                                    ...
                                    <div class="center-wrap">
                                        <div class="section text-center">
                                            <form action="login" method="post">
                                                <img src="img/login_logo2.png" style="margin-left: 5px; margin-bottom: -20px;" onclick="window.location.href='index3.jsp'"/>
                                                ...
                                                <button type="button" onclick="window.location.href='signup.jsp'" class="btn mt-5">SignUp</button>
                                    ...
                                    <div class="center-wrap">
                                        <div class="section text-center">
                                            <form action="adminlogin" method="post">
                                                ...
                                                <button type="submit" class="btn mt-4">Submit</button> 
                                                <button type="button" onclick="window.location.href='adminSignup.jsp'" class="btn mt-5">SignUp</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
