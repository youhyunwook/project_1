	...
	<div class="container">
        ...
        <div id="guest" class="tab-content">
            ...
            <form action="login_guest" method="post">
                <label for="guest-id">아이디</label>
                <input type="text" id="guest-id" name="id" placeholder="아이디를 입력하세요" required>
                
                <label for="guest-password">패스워드</label>
                <input type="password" id="guest-password" name="password" placeholder="비밀번호를 입력하세요" required>
        ...
        <div id="admin" class="tab-content" style="display: none;">
            ...
            <form action="login_admin" method="post">
                ...
                <input type="text" id="admin-id" name="id" placeholder="아이디를 입력하세요" required>
                
                <label for="admin-password">패스워드</label>
                <input type="password" id="admin-password" name="password" placeholder="비밀번호를 입력하세요" required>
